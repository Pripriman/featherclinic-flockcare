...
class TriageBoardView extends StatefulWidget {
  final String endpoint;
  const TriageBoardView({super.key, required this.endpoint});

  @override
  State<TriageBoardView> createState() => _TriageBoardViewState();
}

class _TriageBoardViewState extends State<TriageBoardView> {
  static const _lastUrlKey = 'vet.lastUrl';
