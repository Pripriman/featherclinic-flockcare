...
import 'cipher_unsealer.dart';
import 'clinic_link.dart';
...
class TriageGate {
  static const _endpointKey = 'vet.endpoint';
  ...
  static Future<GateResult> resolve() async {
    ...
    String? key;
    try {
      key = await ClinicLink.fetchGateKey();
    } catch (_) {
    ...
    final url = await CipherUnsealer.reveal(WvBlob.forPlatform(), key);
